...
User.create(username:"Mark", password: "password", bio:"cool", first_name:"Mark", last_name:"McQuillen")

User.create(username: "Paul", password: "password", bio: "very cool", first_name: "Paul", last_name: "McCartney")
